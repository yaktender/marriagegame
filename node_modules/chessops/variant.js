...
Object.defineProperty(exports, "PositionError", { enumerable: true, get: function () { return chess_1.PositionError; } });
Object.defineProperty(exports, "Position", { enumerable: true, get: function () { return chess_1.Position; } });
Object.defineProperty(exports, "IllegalSetup", { enumerable: true, get: function () { return chess_1.IllegalSetup; } });
Object.defineProperty(exports, "Castles", { enumerable: true, get: function () { return chess_1.Castles; } });
...
class Crazyhouse extends chess_1.Chess {
    ...
    dropDests(ctx) {
        var _a, _b;
        const mask = this.board.occupied.complement().intersect(((_a = this.pockets) === null || _a === void 0 ? void 0 : _a[this.turn].hasNonPawns()) ? squareSet_1.SquareSet.full() :
            ((_b = this.pockets) === null || _b === void 0 ? void 0 : _b[this.turn].hasPawns()) ? squareSet_1.SquareSet.backranks().complement() :
...
class RacingKings extends chess_1.Chess {
    ...
    validate() {
        if (this.isCheck())
            return result_1.Result.err(new chess_1.PositionError(chess_1.IllegalSetup.ImpossibleCheck));
